...
LilyPond とは, GPL ライセンスのもとにフリーで公開されているクロスプラットフォームの楽譜作成ソフトウェア<sup><a href="#f1">1</a></sup>である. 
...
---
<p id="f1"><strong>1.</strong> 主流は MuseScore, Finale, Sibelius, Notion, Dorico, etc...</p>